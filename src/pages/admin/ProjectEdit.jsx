...
export default function ProjectEdit() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`${API_BASE_URL}/projects/${id}`, postData, config)
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md border border-gray-150 mt-6">
          <h2 className="text-2xl font-bold mb-6 text-gray-800">Edit Portfolio Project</h2>
          ...
          {loading ? (
            <div className="text-center py-10 font-medium text-gray-500">Loading project details...</div>
          ) : (
